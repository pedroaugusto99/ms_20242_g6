...
import styles from '../styles/cssPages/Dashboard.module.css';
import profile4 from '../images/dashboard/profile-4.jpg';

import Sidebar from '../../components/Sidebar';
import Grafico from '../../components/Grafico';
import Donut from '../../components/Donut';
import useAuth from '../../hooks/dashboardHooks/useAuth';
import useDashboard from '../../hooks/dashboardHooks/useDashboard';

const Dashboard = () => {
    const { nomeUsuario, roleUsuario } = useAuth();
    const { orders, reminders, reminderTitle, setReminderTitle, reminderTime, setReminderTime, addReminder, removeReminder, trabalhadores, numeroDeAnimais, numeroDeAnimaisFemeas, numeroDeAnimaisMachos } = useDashboard();
