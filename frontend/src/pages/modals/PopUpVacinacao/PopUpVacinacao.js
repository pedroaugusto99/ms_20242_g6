...
import VacinacaoComponente from './VacinacaoComponente';
  ...
  return (
    <div className={styles.modal}>
      ...
      <div className={styles.modalContent}>
        ...
        <VacinacaoComponente data={vacinacaoData} columns={['Nome da Vacina', 'Data da Aplicação', 'Número de Doses', 'Data da Próxima Aplicação']} />
