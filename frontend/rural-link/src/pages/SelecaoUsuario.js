...
import styles from './css/cssPages/SelecaoUsuario.module.css'; // Importando como módulo
...
function CardUsuario({ descricao, link, icone, titulo }) {
    return (
        <div className={styles.cardUsuario}>
            ...
            <a href={link} className={styles.linkUsuario}>
                <div className={styles.botaoUsuario}>
                    <img src={icone} alt={`Ícone de ${titulo}`} className={styles.iconeUsuario} />
